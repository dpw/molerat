...
SRCS=base.c buffer.c buffer_test.c thread.c tasklet.c queue.c socket.c echo_server.c tasklet_test.c queue_test.c socket_test.c echo_server_main.c http-parser/http_parser.c http_reader.c http_server.c http_server_main.c http_client.c skinny-mutex/skinny_mutex.c
HDRS=base.h buffer.h thread.h tasklet.h queue.h socket.h echo_server.h http-parser/http_parser.h http_reader.h http_server.h skinny-mutex/skinny_mutex.h
